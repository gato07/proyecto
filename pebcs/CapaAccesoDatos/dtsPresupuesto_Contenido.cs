...
namespace CapaAccesoDatos
{
    public class dtsPresupuesto_Contenido
    {
        ...
        public dtsPresupuesto_Contenido(int Numero_Presupuesto, int Numero_Concepto, int Cantidad, decimal Total)
        {
            try
            {
        ...
        public bool dtsInsertar(int Numero_Presupuesto, int Numero_Concepto, int Cantidad, decimal Total)
        {
            try
            {
                bool res = false;
                ...
                res = conexion.Consulta_Accion("CALL SP_PresCont_Insertar(" + Numero_Presupuesto + ","
                    + Numero_Concepto + "," + Cantidad + "," + Total + ");");
                conexion.Desconectar();
                return res;
            }
            catch (Exception ex)
        ...
        public bool dtsActualizar(int Numero_Presupuesto, int Numero_Concepto, int Cantidad, decimal Total)
        {
            try
            {
                bool res = false;
